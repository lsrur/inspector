<?php
$exceptions = $collectors['Exceptions']['items'];$c=1;
?>
<div class="container-fluid inspector-panel" id='panel-Exceptions'>
	<div class="row">
			...
			<div class="panels"">
				...
				@endif
				@endforeach
				<h5><a href='javascript:void(0)' class="trace-link" style="text-decoration: " id="{{$c}}">TRACE...</a></h5>
				<div style="display: none" id='trace-panel-{{$c}}'>
